...
_SYSTEM: Final[dict[int, str]] = {1: _SYSTEM_V1, 2: _SYSTEM_V2}
_MONTAGE_USER: Final[dict[int, str]] = {1: _MONTAGE_USER_V1, 2: _MONTAGE_USER_V2}
_FRAME_USER: Final[dict[int, str]] = {1: _FRAME_USER_V1, 2: _FRAME_USER_V2}
